...
class DeleteTransactionUseCaseTest {
    ...
    fun setUp() {
        ...
        useCase = DeleteTransactionUseCase(transactionRepository, accountRepository)
    }

    @Test
    fun `eliminar gasto devuelve el dinero al saldo`() = runTest {
        val account = Account(id = 1, name = "Efectivo", currentBalance = 800.0, type = "cash")
        ...
        coVerify {
            accountRepository.updateAccount(match { it.currentBalance == 1000.0 })
        }
    }

    @Test
    fun `eliminar ingreso resta el dinero del saldo`() = runTest {
        val account = Account(id = 1, name = "Efectivo", currentBalance = 1500.0, type = "cash")
    ...
    @Test
    fun `verifica que se llama a deleteTransaction y updateAccount`() = runTest {
